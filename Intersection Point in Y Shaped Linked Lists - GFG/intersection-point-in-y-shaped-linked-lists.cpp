...
int intersectPoint(Node* head1, Node* head2)
{
    ...
    // Move the pointer of the longer list till both become remain equal in length
    t1 = head1; t2 = head2;
    while(l1<l2) t2 = t2->next, l2--;
    while(l2<l1) t1 = t1->next, l1--;
    
    // Compare pointers for same node
    while(t1 and t2) {
